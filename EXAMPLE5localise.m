...
startPositions =  [20,80; 30,20; 50,70 ]; %These will change
...
botSim.setTurningNoise(1/250);

botSim.randomPose(15); %puts the robot in a random position at least 10cm away from a wall
%botSim.setBotAng(randon());
